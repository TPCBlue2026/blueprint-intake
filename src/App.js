...
const CONSULTATION_EMERGE=[
  ...
  {num:'04',id:'bookcall',name:'Book a Call',sections:[
    ...
    {id:'scheduler',name:'Scheduling tool',sub:'Your booking link',
      why:'Victoria will embed your scheduler on this page.',
      fields:[
        {id:'tool',label:'Scheduling tool name',type:'sel',options:['Calendly','Acuity Scheduling','HoneyBook','Dubsado','Square Appointments','Other']},
        {id:'link',label:'Booking link URL',type:'text',guidance:'',ph:'e.g. https://calendly.com/yourbusiness/discovery-call'},
        {id:'calltype',label:'Call type name',type:'text',guidance:'',ph:'e.g. Free Discovery Call'},
        {id:'duration',label:'Duration',type:'text',guidance:'',ph:'e.g. 20 minutes'},
      ]},
    {id:'booktrust',name:'Reassurance note',sub:'Below the scheduler',
      why:'Reduces "is this a hard sell?" anxiety right before commitment.',
